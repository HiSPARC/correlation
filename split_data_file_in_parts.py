...
def split_data_file_in_parts(variable,seconds):
    ...
    for day in time_chunks:
        list_with_pulseheights = [] # e,g, list with pulseheights of n plates (timestamps removed)
        for i in day:
            list_with_pulseheights.append(i[1])
...
if __name__=="__main__":
    variable = [('pulseheights','data_s501_2011,12,8 - 2011,12,12.h5','501','events')]
    #variable = [('integrals','data_s501_2011,12,7 - 2011,12,8.h5','501','events','')]
    #variable = [('pulseheights','data_s501_2011,12,7 - 2011,12,8.h5','501','events'),('pulseheights','data_s501_2011,12,8 - 2011,12,9.h5','501','events')]

    #variable = [('barometer','data_s501_2011,12,7 - 2011,12,8.h5','501','weather','')]
    seconds = 86400
